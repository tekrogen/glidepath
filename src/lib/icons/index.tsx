 ...
 * Shared Icon Library
 *
 * Centralized icon components to eliminate duplication across the codebase.
 * All icons follow a consistent API with an optional className prop.
 */
